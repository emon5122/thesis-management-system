...
const Modal = ({ showMe, setShowMe }: { showMe: boolean, setShowMe: any }) => {
    ...
    >
      <div className="w-[500px] flex flex-col">
        ...
        <div className="bg-white p-2 ml-8 rounded">
          ...
          <button
            className="flex items-center m-auto mt-2 pr-4 rounded-lg border-2 border-cyan-800 text-cyan-800  hover:bg-gray-300 group"
            onClick={() => setShowMe(false)}
          >
